...
if __name__ == '__main__':
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
        ...
        while True:
            ...
            The optional @timeout specifies a time-out as a floating point
            number in seconds. When the timeout argument is omitted the
            function blocks until at least one file descriptor (i.e.: file
            object, socket) is ready.
            """
