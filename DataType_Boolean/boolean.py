...
print("0 or 1:\t\t{}".format(bool(0 or 1)))
print("[2] and {{}}:\t{}".format(bool([2] and {})))

print("2 < 5 and 7 > 0:\t{}".format(2 < 5 and 7 > 0))

# The next expression would raise an error when comparing 7 to a str,
# but because the first condition is False, using the AND operator
# will stop the comparisions as soon as one False is found.
print('\nAvoided error:')
