...
In Linux we can see them with the command 'export' or 'printenv' in the terminal.
...
Setting env variables:
    ...
    - Using os.environ['NEW_KEY'] = 'NEW_VALUE' in Python, they will be erased after killing the process.
    - In some code editors (like Pycharm), it's possible to add them to the project's configuration.
"""
import os
