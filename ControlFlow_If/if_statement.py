...
# Followed by 0 or more elif clauses - elif comes from else-if
# elif age > 99:
elif not (age < 99):
    print('Black screen')
elif age == 24:
...
# Can have 0 or 1 else clause, will run always as long as
# none of the above if/elif was True
else:
    print('Come back in {0} years'.format(18 - age))

x = input('Enter some text: ')

# Will return True if the variable is not a 0, neither None,
# nor empty srt, list, dict, tuple...
